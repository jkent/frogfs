...
#### Object functions:
  ...
  * int [frogfs_is_dir](https://frogfs.readthedocs.io/en/next/api-reference/bare.html#c.frogfs_is_dir)(const frogfs_entry_t *entry)
  * int [frogfs_is_file](https://frogfs.readthedocs.io/en/next/api-reference/bare.html#c.frogfs_is_file)(const frogfs_entry_t *entry)
  ...
  * int [frogfs_is_raw](https://frogfs.readthedocs.io/en/next/api-reference/bare.html#c.frogfs_is_raw)(frogfs_fh_t *fh)
